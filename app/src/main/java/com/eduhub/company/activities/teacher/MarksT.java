...
public class MarksT extends AppCompatActivity {
    ...
    private void getList(){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FileSharingAdapter fileSharingAdapter = new FileSharingAdapter(uploads,MarksT.this);
    ...
    private void getPDF() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && ContextCompat.checkSelfPermission(MarksT.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PDF_CODE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (data.getData() != null) {
                ...
                new DatabaseManagement(getApplicationContext()).uploadFile(uri,addressTo,name,"marks");
            }else{
